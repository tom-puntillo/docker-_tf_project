...
module "ec2_docker_ubuntu" {
  ...
  security_groups = [module.security_groups.security_group_http, module.security_groups.security_group_tls, module.security_groups.security_group_docker, module.security_groups.security_group_jenkins]
}
